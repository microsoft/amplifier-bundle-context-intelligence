<!-- DEPRECATED BASELINE: Served when the server is reachable but < 2.0.0 (no /skills/ endpoint). Remove this file and write_legacy_content() once all deployments are >= 2.0.0. -->
